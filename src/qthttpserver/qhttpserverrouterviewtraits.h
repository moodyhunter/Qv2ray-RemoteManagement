...
namespace QtPrivate
{
    ...
    struct RouterViewTraitsHelper : ViewTraits<ViewHandler, DisableStaticAssert>
    {
        ...
        struct ArgumentChecker : FunctionTraits::template Arg<I>
        {
            ...
            static_assert(IsRequest::AssertCondition, "ViewHandler arguments error: "
            ...
            static_assert(IsResponder::AssertCondition, "ViewHandler arguments error: "
            ...
            struct IsSimple
            {
                static constexpr bool Value = !IsSpecial::Value && I < FunctionTraits::ArgumentCount && FunctionTraits::ArgumentIndexMax != -1;
                static constexpr bool Valid = FunctionTraits::template Arg<I>::Defined;

                static constexpr bool StaticAssert = DisableStaticAssert || !Value || Valid;

                static_assert(StaticAssert, "ViewHandler arguments error: "
        ...
        struct Arguments
        {
            ...
            struct ArgumentsReturn
            {
                ...
                static constexpr int metaTypeId() noexcept
                {
                    ...
                    return qMetaTypeId<typename std::conditional<QMetaTypeId2<Type>::Defined, Type, void>::type>();
                }

                static constexpr std::size_t Count = FunctionTraits::ArgumentCount;
                static constexpr std::size_t CapturableCount = StaticMath::Sum::eval(static_cast<std::size_t>(FunctionTraits::template Arg<I>::Defined)...);
                ...
                static constexpr bool StaticAssert = StaticMath::And::eval(Arg<I>::StaticAssert...);

                using Indexes = typename QtPrivate::IndexesList<I...>;

                using CapturableIndexes = typename QtPrivate::Indexes<CapturableCount>::Value;

                using PlaceholdersIndexes = typename QtPrivate::Indexes<PlaceholdersCount>::Value;
        ...
        struct BindType
        {
            ...
            template<int... Idx>
            static constexpr typename FunctionWrapper<OffsetArg<Idx>...>::Type eval(QtPrivate::IndexesList<Idx...>) noexcept;
        };
    };
...
struct QHttpServerRouterViewTraits
{
    ...
    using BindableType = decltype(Helpers::template BindType<Arguments::CapturableCount>::eval(typename Arguments::PlaceholdersIndexes{}));
};
