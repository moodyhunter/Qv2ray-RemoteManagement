...
namespace QtPrivate
{
    ...
    struct AfterRequestViewTraitsHelper : ViewTraits<ViewHandler, DisableStaticAssert>
    {
        ...
        static_assert(DisableStaticAssert || FunctionTraits::ArgumentCount == 2 || FunctionTraits::ArgumentCount == 1,
                      "ViewHandler arguments error: "
                      "afterRequest can only accept QHttpServerResponse and QHttpServerRequest");

        static_assert(DisableStaticAssert || std::is_same<typename FunctionTraits::ReturnType, QHttpServerResponse>::value,
        ...
        struct ArgumentChecker
        {
            ...
            static_assert(IsResponse::AssertCondition, "ViewHandler arguments error: "
        ...
        struct Arguments
        {
            ...
            struct ArgumentsReturn
            {
                ...
                static constexpr bool StaticAssert = QtPrivate::StaticMath::And::eval(Arg<I>::StaticAssert...);
